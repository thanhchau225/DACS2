...
<head>
    <title>Hệ Thống Quản Lý Rác: Giao Công Việc Khiếu Nại</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Giao Công Việc Khiếu Nại</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Giao</strong> Công Việc Khiếu Nại </h2>
                            </div>
                            <div class="body">
