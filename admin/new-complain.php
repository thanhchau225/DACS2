...
<head>
    <title>Hệ Thống Quản Lý Rác Thải: Khiếu Nại Mới Được Đăng</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Khiếu Nại Mới Được Đăng</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Khiếu Nại Mới Được Đăng</strong></h2>
                            </div>
                            <div class="body">
