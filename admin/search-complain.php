...
<head>
    ...
    <title>Hệ Thống Quản Lý Rác Thải: Tìm Kiếm Khiếu Nại Đã Giao</title>
       ...
       <?php include_once('includes/sidebar.php');?> 
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Tìm Kiếm Khiếu Nại Đã Giao</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Tìm Kiếm Khiếu Nại Đã Giao </h2>
                            </div>
                            <div class="body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Nhập Mã Khiếu Nại"></div>
