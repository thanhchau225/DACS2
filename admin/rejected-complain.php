...
<head>
    ...
    <title>Hệ Thống Quản Lý Rác Thải: Khiếu Nại Đã Bị Từ Chối</title>
       ...
       <?php include_once('includes/sidebar.php');?> 
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Khiếu Nại Đã Bị Từ Chối</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Khiếu Nại Đã Bị Từ Chối</strong> </h2>
                            </div>
                            <div class="body">
