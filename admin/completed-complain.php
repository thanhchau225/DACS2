...
<head>
    ...
    <title>Hệ Thống Quản Lý Rác Thải: Khiếu Nại Đã Giải Quyết</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Khiếu Nại Đã Giải Quyết</a>
            </nav>
...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?> (Phân công cho <?php  echo htmlentities($row->AssignTo);?>)
                  </td>
                  <?php } ?>         
                 
                                        <td><a href="view-driver-response-complain-detail.php?editid=<?php echo htmlentities ($row->compid);?>&&comid=<?php echo htmlentities ($row->ComplainNumber);?>" class="btn btn-primary">Xem</a></td>
                                            </tr>
                                         <?php $cnt=$cnt+1;}} ?> 
                                        </tbody>
                                    </table>
...
<script src="../assets/js/theme.js"></script><!-- Tùy Chỉnh JS --> 
