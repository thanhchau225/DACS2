...
<head>
    <title>Hệ thống quản lý rác thải: Tất cả khiếu nại đã ghi</title>
    ...
    <div class="main_content" id="main-content">
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Tất cả khiếu nại đã ghi</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Tất cả</strong> khiếu nại </h2>
                            </div>
                            <div class="body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row->Status == "" ? "Chưa được cập nhật" : htmlentities($row->Status) . " (Giao cho " . htmlentities($row->AssignTo) . ")"; ?></td>
                                                        <td>
                                                            <a href="view-complain-detail.php?editid=<?php echo htmlentities($row->compid); ?>&&comid=<?php echo htmlentities($row->ComplainNumber); ?>" class="btn btn-primary">Xem</a>
                                                        </td>
                                                    </tr>
                                            <?php 
                                                    $cnt++;
