...
<head>
    <title>Hệ Thống Quản Lý Rác Thải: Báo Cáo Khiếu Nại Theo Ngày</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Báo Cáo Khiếu Nại Theo Ngày</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Báo Cáo Khiếu Nại Theo Ngày</h2>
                            </div>
