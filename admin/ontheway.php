...
<head>
    <title>Hệ Thống Quản Lý Rác Thải: Thùng rác đang trên đường đến khu vực thu gom</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Thùng rác đang trên đường đến khu vực thu gom</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Thùng rác đang trên đường đến khu vực thu gom</h2>
                            </div>
                            <div class="body">
